      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li>
              <router-link :to="{ name: 'transactions.add' }">Transaction</router-link>
            </li>
                  ...
                  <ul class="menu" v-if="notifications.length > 0">
                    <li v-for="(row, index) in notifications" :key="index">
                      <a href="javascript:void(0)" @click="readNotif(row)">
                        <div class="pull-left" v-if="row.data.photo != null">
                          <img
                            :src="'/storage/couriers/' + row.data.photo"
                            :width="80"
                            :height="50"
                            :alt="row.data.sender_name"
                          />
                        </div>
                        <h4>
                          {{ row.data.sender_name }} {{ row.data.user }}
                          <small>
